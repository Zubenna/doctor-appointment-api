      ...
      class DoctorsController < ApplicationController
          ...
          def update
            ...
            if doctor.update_attributes(doctor_params)
              ...
              render json: {status: 'ERROR', message: 'Doctor not updated', data:doctor.errors},status: :unprocessable_entity
            end
          end
          ...
          def doctor_params
            params.permit(:firstname, :lastname, :email, :phonenumber, :specialty, :years_of_experience, :picture, :location)
          end
      end
    end
  end